...
const SearchHotelPredictPage = () => {
  ...
  const fetchHotels = async (name: string) => {
    if (!name) return;
    try {
      const response = await fetch(`http://127.0.0.1:3000/api/hotel/country`, {
        method: "POST",
        headers: {
          ...
          <div className={styles.searchResults}>
            ...
            <div className={styles.paginationContainer}>
              ...
              <div className={styles.resultsPerPageDropdown}>
                <label
                  className="text-md font-weight-500"
...
export default SearchHotelPredictPage;
